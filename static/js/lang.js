...
// AUTO-GENERATED by bin/compile_lang.py — edit lang/*.tsv instead
const LANGUAGES = {
...
const TRANSLATIONS = {
    ...
    ja: {
        ...
        readingSave: 'テーマを設定',
        readingClear: 'クリア',
        sharedLinkTitle: '共有されたスプレッド',
        sharedLinkMessage: '誰かがスプレッドを共有しました。表示しますか？',
        sharedLinkYes: 'はい',
        sharedLinkNo: 'いいえ',
        sharedLinkNever: '今後警告しない',
